<?php
    ...
    // Si no existen el usuario (variables de session) al intentar ingresar por url se bloquea el acceso
...
<body>
  ...
  <main class="container">
    <!-- Esta instruccion aparecera en toda la app cuando se ejecute -->
    <?php if(isset($_GET['mensaje'])) { ?>
        <script>
            // Si esta declarado el mensaje, se mostrara tanto en url como en el alert
